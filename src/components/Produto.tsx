  ...
  return (
    <div className="container">
      ...
      <div className="form">
        ...
        <button className="button cadastrar" onClick={handleAddProduto}>
          Adicionar Produto
        </button>
      </div>
        ...
        <ul className="fornecedor-list">
          {produtosFiltrados().map(produto => (
            <li key={produto.id} className="fornecedor-item">
              ...
              <button className="button editar" onClick={() => handleEditProduto(produto.id)}>Editar</button>
              <button className="button excluir" onClick={() => handleDeleteProduto(produto.id)}>Excluir</button>
            </li>
          ))}
        </ul>
      </div>
